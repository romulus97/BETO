...
cbar = plt.colorbar(ScalarMappable(norm=plt.Normalize(0,500000), cmap='cool'), ax=ax, shrink=0.75, pad=0.09)
...
#plt.savefig('max_energy_shortfall_scaled_a.tiff',dpi=300)   # idx1
#plt.savefig('min_GHG_emission_scaled_a.tiff',dpi=300)         # idx2
plt.savefig('cost_scaled_c.tiff',dpi=300)                   # idx3 