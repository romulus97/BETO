...
fig = px.scatter_3d(df_O, x='cost', y='energy_shortfall', z='GHG_emission',color='kg', hover_data=['kg'])
...
fig.show()
fig.write_html("Comparison energy_shortfall,GHG_emission and cost with kg.html")
