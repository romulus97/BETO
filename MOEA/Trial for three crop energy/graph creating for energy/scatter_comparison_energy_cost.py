...
biomass_cost = list(df_obj['biomass_cost'])
shortfall_corn = list(df_obj['min_energy_shortfall'])

##minimum shortfall and maximum biomass cost index
maxbio_cost = max(biomass_cost)
idx = biomass_cost.index(maxbio_cost)

##maximum shortfall and minimum biomass cost index
minbio_cost = min(biomass_cost)
idxm = biomass_cost.index(minbio_cost)
