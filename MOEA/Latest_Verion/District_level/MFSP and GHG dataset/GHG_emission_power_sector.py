...
for c in crops:
    ...
    if c == 'AlgaeNLC':
        final_data.to_excel('Algae_GHG.xlsx',index=False)

    elif c == 'CornNLC':
        final_data.to_excel('Corn_GHG.xlsx',index=False)
    
    elif c == 'SoyNLC':
        final_data.to_excel('Soy_GHG.xlsx',index=False)
        
    elif c == 'SwitchNLC':
        final_data.to_excel('Switchgrass_GHG.xlsx',index=False)
