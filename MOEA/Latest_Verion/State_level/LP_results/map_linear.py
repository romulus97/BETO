...
for b in billion:
    ...
    fn_ha = 'land_usage_out_state_level_' + b +'.csv'
    ...
    fn_ha_ghg = 'land_usage_out_state_level_GHG_' + b +'.csv'
    ...
    plt.savefig('Compressed_map_state_linear' + b+ '.png',dpi=150, bbox_inches='tight')
