...
# GHG_cult_algal = list(df_geo_algae['GHG(g CO2e/ha)'])  # algae_GHG_per_ha
...
# # GHG_proc_algal = list(df_geo_algae['GHG_proc_(g CO2e/kg/yr)'])  # algae_cost_per_kg/yr
...
for sol in solutions:
    ...
    sol_reg_p = sol_reg[0]
    R2_acrage_vs_cult_GHG[sol] = sol_reg_p
    # print(linregress(X, y))
...
for sol in solutions:
    ...
    sol_reg = scipy.stats.pearsonr(X,y) 
    sol_reg_p = sol_reg[0]
    R2_acrage_vs_scult_GHG[sol] = sol_reg_p
...
for sol in solutions:
    ...
    sol_reg = scipy.stats.pearsonr(X,y) 
    sol_reg_p = sol_reg[0]
    R2_acrage_vs_gcult_GHG[sol] = sol_reg_p
...
for sol in solutions:
    ...
    sol_reg = scipy.stats.pearsonr(X,y) 
    sol_reg_p = sol_reg[0]
    R2_acrage_vs_acult_GHG[sol] = sol_reg_p

df_reg_R2['R2_c_acrage_vs_power_GHG'] = R2_acrage_vs_cult_GHG
df_reg_R2['R2_s_acrage_vs_power_GHG'] = R2_acrage_vs_scult_GHG
df_reg_R2['R2_g_acrage_vs_power_GHG'] = R2_acrage_vs_gcult_GHG
df_reg_R2['R2_a_acrage_vs_power_GHG'] = R2_acrage_vs_acult_GHG
...
df_reg_R2['R2_c_acrage_vs_electricity_p'] = sol_reg_sign
df_reg_R2['R2_s_acrage_vs_electricity_p'] = sol_reg_sign_s
df_reg_R2['R2_g_acrage_vs_electricity_p'] = sol_reg_sign_g
df_reg_R2['R2_a_acrage_vs_electricity_p'] = sol_reg_sign_a
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_cost[sol] = sol_reg_ap
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_mgcost[sol] = sol_reg_ap    
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_macost[sol] = sol_reg_ap

df_reg_R2['R2_c_acrage_vs_land_cost'] = R2_acrage_vs_cost
df_reg_R2['R2_g_acrage_vs_ml_cost'] = R2_acrage_vs_mgcost
df_reg_R2['R2_a_acrage_vs_ml_cost'] = R2_acrage_vs_macost
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_limit[sol] = sol_reg_ap
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_mglimit[sol] = sol_reg_ap
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_malimit[sol] = sol_reg_ap    

df_reg_R2['R2_c_acrage_vs_land_limit'] = R2_acrage_vs_limit
df_reg_R2['R2_g_acrage_vs_ml_limit'] = R2_acrage_vs_mglimit
df_reg_R2['R2_a_acrage_vs_ml_limit'] = R2_acrage_vs_malimit
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_cyield[sol] = sol_reg_ap
...
for sol in solutions:
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_syield[sol] = sol_reg_ap
    
    
## Grass acrage vs grass yield
for sol in solutions:
    df_reg['grass_acrage'] = G_ha[:,sol]
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_gyield[sol] = sol_reg_ap

    
    
## Algae acrage vs algae yield
for sol in solutions:
    df_reg['algae_acrage'] = A_ha[:,sol]
    ...
    sol_reg_ap = sol_reg_a[0]
    sol_reg_sign_a[sol]= sol_reg_ap
    R2_acrage_vs_ayield[sol] = sol_reg_ap
    
df_reg_R2['R2_c_acrage_vs_cyield'] = R2_acrage_vs_cyield
df_reg_R2['R2_s_acrage_vs_syield'] = R2_acrage_vs_syield
df_reg_R2['R2_g_acrage_vs_gyield'] = R2_acrage_vs_gyield
df_reg_R2['R2_a_acrage_vs_ayield'] = R2_acrage_vs_ayield
