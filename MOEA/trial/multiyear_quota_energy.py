...
def QD (districts,locations):
    ...
    LC1 = marginal_land_costs # land costs per county
    ...
    for b in years:
        ...
        for c in range(0,len(LC)):
            ...
            G_D2H_prod[c,:] = D2H_map[c,:]*G_Y[c]*(V[c]/2)
        ...
        Energy_corn = ( 29.7 * CG_ethanol + 39.6 * SB_oil + G_energy)   # Ethanol - 29.7 MJ/kg and Soy Oil - 39.6 MJ/kg
