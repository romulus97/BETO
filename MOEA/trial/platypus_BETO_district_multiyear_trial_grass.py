...
def simulate(
        ...
        vars1, # cultivation hectares per county for corn, hub-to-hub biomass flows
    ...
    for year in years:
        ...
        Energy =( G_energy)   # Ethanol - 29.7 MJ/kg and Soy Oil - 39.6 MJ/kg
    ...
    biomass_cost = biomass_cost_grass
    min_shortfall = max(Z)
...
for i in range(0,np.size(land_costs)):
    problem.types[i] = Real(0,marginal_land_limits[i]+5)
