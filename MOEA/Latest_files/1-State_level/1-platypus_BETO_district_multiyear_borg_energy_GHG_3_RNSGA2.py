...
ref_points = np.array([0.02135,350000000000,29.3486])
...
df_D = pd.DataFrame(D)
fn = 'Decision_Variables_borg_crops_GHG3_R' + version + '.csv'
df_D.to_csv(fn)

df_O = pd.DataFrame(O)
fn2 = 'Objective_functions_borg_crops_GHG3_R' + version + '.csv'
df_O.to_csv(fn2)
