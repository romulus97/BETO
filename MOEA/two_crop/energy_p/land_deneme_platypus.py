...
import deneme_quota
p=.05
Q_min, Q_series = deneme_quota.QD(districts,locations)
...
def simulate(
    ...
    for year in years:
        ...
        Energy =(81.239301/3.79) *  (CG_ethanol + SB_oil)
    ...
    min_shortfall = max(Z)
    return [biomass_cost_corn, biomass_cost_soy, min_shortfall, A ], Constraints ##
