...
for ind in ind_min_cost:
    ...
    ax.set_ylabel('Total Produced MJ', fontsize=18)
    ax.set_xlabel('Years', fontsize=18)
    
    ax.tick_params(axis='both', which='major', labelsize=15)
    ax.set_xticklabels(labels,rotation=40,fontsize=15)
    ...
    ax.set_title('Minimum Quota Shortfall (MJ)',fontsize=18,fontweight="bold")
    # ax.set_title('Minimum GHG Intensity (tons $CO_{2}$/MJ)',fontsize=18,fontweight="bold")
    # ax.set_title('Minimum Cost ($/MJ)',fontsize=18,fontweight="bold")
...
for indm in ind_max_cost:
    ...
    ax.set_title('Maximum Quota Shortfall (MJ)',fontsize=18, fontweight="bold")
    # ax.set_title('Maximum GHG Intensity (tons $CO_{2}$/MJ)',fontsize=18, fontweight="bold")
    # ax.set_title('Maximum cost ($/MJ)',fontsize=18, fontweight="bold")
