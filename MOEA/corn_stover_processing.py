...
def sim(kg_stover):
    ...
    Comminution_Electricity = kg_stover * Percent_to_hammer_mill / 100 #MJ
    kg_comm_stover = kg_stover * Comminution_energy # kg comminuted stover 
    ...
    gal_ethanol_per_ton_stover = ( L_ethanol / gal_to_L ) / (kg_stover * kg_to_ton )
