...
plt.savefig('min_energy_shortfall.tiff',dpi=300)

# find minimum trans opex
l = list(df_O['energy_changes'])
idx2c = l.index(min(l))

#minimum trans opex
d_sample = list(df_D.iloc[idx2c,0:len(districts)])
cmap = matplotlib.cm.get_cmap('cool')
# M = max(d_sample)
M = np.max(df_D.iloc[:,0:len(districts)].values)
...
plt.savefig('energy_changes.tiff',dpi=300)
...
#minimum land_costs
d_sample = list(df_D.iloc[idx3c,0:len(districts)])
cmap = matplotlib.cm.get_cmap('cool')
# M = max(d_sample)
M = np.max(df_D.iloc[:,0:len(districts)].values)
...
d_sample = list(df_G.iloc[idx1g,len(districts):])
dvs = int(np.sqrt(len(d_sample)))
refinery_flow = np.zeros((dvs,))
for i in range(0,dvs):
    for j in range(0,dvs):
...
plt.savefig('min_energy_shortfall_grass.tiff',dpi=300)
...
#minimum trans opex
d_sample = list(df_G.iloc[idx2g,0:len(districts)])
cmap = matplotlib.cm.get_cmap('cool')
# M = max(d_sample)
M = np.max(df_G.iloc[:,0:len(districts)].values)
...
plt.savefig('energy_changes_grass.tiff',dpi=300)
...
#minimum land_costs
d_sample = list(df_G.iloc[idx3g,0:len(districts)])
cmap = matplotlib.cm.get_cmap('cool')
# M = max(d_sample)
M = np.max(df_G.iloc[:,0:len(districts)].values)
...
d_sample = list(df_A.iloc[idx1a,len(districts):])
dvs = int(np.sqrt(len(d_sample)))
refinery_flow = np.zeros((dvs,))
for i in range(0,dvs):
    for j in range(0,dvs):
...
plt.savefig('min_energy_shortfall_algae.tiff',dpi=300)
...
#minimum trans opex
d_sample = list(df_A.iloc[idx2a,0:len(districts)])
cmap = matplotlib.cm.get_cmap('cool')
# M = max(d_sample)
M = np.max(df_A.iloc[:,0:len(districts)].values)
...
plt.savefig('energy_changes_algae.tiff',dpi=300)
...
#minimum land_costs
d_sample = list(df_A.iloc[idx3a,0:len(districts)])
cmap = matplotlib.cm.get_cmap('cool')
# M = max(d_sample)
M = np.max(df_A.iloc[:,0:len(districts)].values)
